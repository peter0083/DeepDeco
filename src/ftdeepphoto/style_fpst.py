...
from src.optimize_ffwd import optimize
...
def build_parser():
    ...
    parser.add_argument('--style-seg', type=str,
                        dest='style_seg', help='style segmentation mask path',
                        metavar='STYLE', required=True)
    ...
    parser.add_argument('--train-seg-dir', type=str,
                        dest='train_seg_dir', help='path to training segmentation masks folder',
                        metavar='TRAIN_PATH', default=TRAIN_SEG)
    ...
    parser.add_argument('--photo-weight', type=float,
                        dest='photo_weight',
                        help='Photorealism regularization weight',
                        metavar='PHOTO_WEIGHT (default %(default)s)', default=PHOTO_WEIGHT)
...
# Intermediate file save directories
    parser.add_argument('--resized-dir', type=str,
                        ...
                        metavar='RESIZED_DIR', default=False)
...
# Deep Lab
    parser.add_argument('--deeplab-path', type=str,
                        ...
                        metavar='DEEPLAB_path', default=False)
    return parser
