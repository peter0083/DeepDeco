...
# curl -F "file=@data/images/chair_sketch.jpeg" -F "text='ice cold patterned glass'" -X POST http://127.0.0.1:5000/image --output flask_output.gif
...
def inference():
    if request.method == 'POST':
        ...
        print("style search time (sec): " + str(style_search_time))
